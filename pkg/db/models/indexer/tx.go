...
var TransactionColumns = []ColumnDef{
	...
	{Name: "tx_index", Type: "UInt32", Codec: "Delta, ZSTD(3)"},
	...
	{Name: "validator_address", Type: "Nullable(String)", Codec: "ZSTD(1)"},
	{Name: "commission", Type: "Nullable(Float64)", Codec: "ZSTD(3)"},
	{Name: "chain_id", Type: "Nullable(UInt64)", Codec: "Delta, ZSTD(3)", CrossChainRename: "tx_chain_id"},
	...
	{Name: "param_value", Type: "Nullable(String)", Codec: "ZSTD(1)"},
	{Name: "committee_id", Type: "Nullable(UInt64)", Codec: "Delta, ZSTD(3)"},
	{Name: "recipient", Type: "Nullable(String)", Codec: "ZSTD(1)"},
	{Name: "poll_hash", Type: "Nullable(String)", Codec: "ZSTD(1)"},
	{Name: "buyer_receive_address", Type: "Nullable(String)", Codec: "ZSTD(1)"},
	{Name: "buyer_send_address", Type: "Nullable(String)", Codec: "ZSTD(1)"},
	{Name: "buyer_chain_deadline", Type: "Nullable(UInt64)", Codec: "Delta, ZSTD(3)"},
